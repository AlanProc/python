...
def prever_afinidade_elemental(intensidade, componente_raro, fase_lunar, idade_feiticeiro, afinidade_animais):
    ...
    if intensidade == 6 and fase_lunar == "crescente" and idade_feiticeiro > 100:
        return "A afinidade elemental do feiticeiro é com o elemento Fogo!"
    if intensidade == 8 and fase_lunar == "cheia" and idade_feiticeiro == 80 and afinidade_animais != afinidade_animais_feiticeiro :
        return "A afinidade elemental do feiticeiro é com o elemento Água!"
    if intensidade == 9 and fase_lunar == "cheia" and idade_feiticeiro == 80:
